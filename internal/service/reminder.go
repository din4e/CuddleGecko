...
type ReminderRepository interface {
	...
	List(ctx context.Context, workspaceID uint, status model.ReminderStatus) ([]model.Reminder, error)
...
func (s *ReminderService) List(ctx context.Context, userID, workspaceID uint, status model.ReminderStatus) ([]model.Reminder, error) {
