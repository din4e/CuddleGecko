...
type Interaction struct {
	...
	WorkspaceID uint            `gorm:"index;not null;default:0;index:idx_interaction_ws_contact_occurred" json:"workspace_id"`
	ContactID   uint            `gorm:"index;not null;index:idx_interaction_ws_contact_occurred" json:"contact_id"`
