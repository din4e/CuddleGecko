...
export const remindersApi = {
  list: (status?: ReminderStatus, page = 1, pageSize = 50, signal?: AbortSignal) =>
    request.get<PaginatedData<Reminder>>('/reminders', { params: { status, page, page_size: pageSize }, signal }).then((data) => ({ data })),
