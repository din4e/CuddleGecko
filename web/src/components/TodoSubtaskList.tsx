...
export interface TodoSubtaskListProps {
   ...
   *  control, matching the tree view) opens an inline adder for THAT row — at
   *  any depth. The parent todo's own entry lives on the host surface (card
   *  toolbar / drawer heading), so there is still exactly one add affordance
   *  per row and no text-style entries. */
 ...
 * toggle, due label, progress, pomodoro, add-child (trailing "+"), delete.
