...
export const commands: CommandDef[] = [
  ...
  },
  {
    ...
    usage: 'create buddy --name <name> [--nickname <nick>] [--birthday <date>] [--notes <text>] [--phones <p1,p2>] [--emails <e1,e2>] [--labels <l1,l2>]',
    category: 'buddies',
    args: [
  ...
  },
  {
    ...
    usage: 'update buddy <id> [--name <name>] [--nickname <nick>] [--birthday <date>] [--notes <text>]',
    category: 'buddies',
    args: [
